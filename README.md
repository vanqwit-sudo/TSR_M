...
Telegram-like messenger с авторизацией, профилем, чатами, сообщениями, фото, GIF, реакциями, поиском, групповыми настройками и совместным просмотром YouTube.

## Что уже есть

- Телефонная и Google-авторизация
- Персонализация профиля с аватаром, статусом и цветами
- Личные чаты и группы
- Отправка текстовых сообщений, фото, GIF и голосовых заметок
- Реакции на сообщения и закрепление сообщений
- Поиск по чатам, пользователям и сообщениям
- Сохранение состояния пользователей и чатов на сервере
- Совместный просмотр YouTube через команду в чате:
  ```text
  !смотреть "название канала" "название видео"
  ```
